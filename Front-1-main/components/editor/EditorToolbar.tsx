  ...
  return (
    <div id="toolbar">
      ...
      <span className="ql-formats">
            ...
            <Savemodal role="importModal">
              ...
              <div className="items">
                {options.map((option, index) => (
                  ...
                  >
                    {option.name} <span className="import-data">{parse_date(option.recieveDate)}</span>
                  </button>
                ))}
              </div>
              <div className="controls">
        ...
        <div className="cont-imp">
          <button className="ql-getliters" onClick={handlegetliters}>
            Lr
          </button>
          {showModalliter && (
            <Savemodal role="importModal">
              ...
              <div className="items">
                {Liters.map((option, index) => (
                  ...
                  >
                    {option.project} <span className="import-data">{parse_date(option.saveDate)}</span>
                    <br/>Title:<span className="import-data">{option.title}</span>
                  </button>
                ))}
              </div>
              <div className="controls">
        ...
        <div className="cont-imp">
          <button className="ql-getrefs" onClick={handlegetrefs}>
            Ref
          </button>
          {showModalrefs && (
            <Savemodal role="importModal">
        ...
        <div className="cont-imp">
          <button className="ql-getarts" onClick={handlegetarts}>
            Ar
          </button>
          {showModalarts && (
            <Savemodal role="importModal">
        ...
        <div className="cont-imp">
          <button className="ql-getarts" onClick={handlegetcites}>
            Cite
          </button>
          {showModalcites && (
            <Savemodal role="importModal">
              ...
              <div className="items">
                {Cites.map((option, index) => (
                  <button key={index} onClick={() => handleCiteSelect(option)}>
                    {option.title} <span className="import-data">{parse_date(option.recieveDate)}</span>
                    <br/>Title:<span className="import-data">{option.title}</span>
                    <br/>Authors:<span className="import-data">{option.authors}</span>
                    <br/>Published:<span className="import-data">{option.year}</span>
                  </button>
                ))}
              </div>
              <div className="controls">
